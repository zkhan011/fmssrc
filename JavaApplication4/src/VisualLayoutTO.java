...
public class VisualLayoutTO
  ...
  public VisualLayoutTO setScaleX(Float scaleX) {
  ...
  public VisualLayoutTO setScaleY(Float scaleY) {
  ...
  public VisualLayoutTO setColors(List<Color> colors) {
  ...
  public VisualLayoutTO setShapeLayoutElements(List<ShapeLayoutElement> shapeLayoutElements) {
  ...
  public VisualLayoutTO setModelLayoutElements(List<ModelLayoutElement> modelLayoutElements) {
  ...
  public VisualLayoutTO setViewBookmarks(List<ViewBookmark> viewBookmarks) {
  ...
  public static class Color {
    ...
    public Color setRedValue(Long redValue) {
    ...
    public Color setGreenValue(Long greenValue) {
    ...
    public Color setBlueValue(Long blueValue) {
  ...
  public static class ShapeLayoutElement {
    ...
    public ShapeLayoutElement setLayer(Long layer) {
    ...
    public ShapeLayoutElement setProperties( List<PropertyTO> properties) {
  ...
  public static class ModelLayoutElement {
    ...
    public ModelLayoutElement setVisualizedObjectName(String visualizedObjectName) {
    ...
    public ModelLayoutElement setLayer(Long layer) {
      requireNonNull(layer, "layer");
      this.layer = layer;
      return this;
    }
    ...
    public ModelLayoutElement setProperties(List<PropertyTO> properties) {
      requireNonNull(properties, "properties");
      this.properties = properties;
      return this;
    }
  ...
  public static class ViewBookmark {
    ...
    public ViewBookmark setLabel(String label) {
    ...
    public ViewBookmark setCenterX(Integer centerX) {
    ...
    public ViewBookmark setCenterY(Integer centerY) {
    ...
    public ViewBookmark setViewScaleX(Float viewScaleX) {
    ...
    public ViewBookmark setViewScaleY(Float viewScaleY) {
    ...
    public ViewBookmark setViewRotation(Integer viewRotation) {
