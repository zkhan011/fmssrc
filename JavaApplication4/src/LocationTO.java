...
public class LocationTO
  ...
  public LocationTO setxPosition(Long xPosition) {
  ...
  public LocationTO setyPosition(Long yPosition) {
  ...
  public LocationTO setzPosition(Long zPosition) {
  ...
  public LocationTO setType(String type) {
  ...
  public LocationTO setLinks(List<Link> links) {
  ...
  public static class Link {
    ...
    public Link setPoint(String point) {
    ...
    public Link setAllowedOperations(List<AllowedOperationTO> allowedOperations) {
