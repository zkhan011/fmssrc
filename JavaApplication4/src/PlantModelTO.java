...
public class PlantModelTO
  ...
  public PlantModelTO setVersion( String version) {
  ...
  public PlantModelTO setPoints(List<PointTO> points) {
  ...
  public PlantModelTO setPaths(List<PathTO> paths) {
  ...
  public PlantModelTO setVehicles(List<VehicleTO> vehicles) {
  ...
  public PlantModelTO setLocationTypes(List<LocationTypeTO> locationTypes) {
  ...
  public PlantModelTO setLocations(List<LocationTO> locations) {
  ...
  public PlantModelTO setBlocks(List<BlockTO> blocks) {
  ...
  public PlantModelTO setStaticRoutes(List<StaticRouteTO> staticRoutes) {
  ...
  public PlantModelTO setGroups(List<GroupTO> groups) {
  ...
  public PlantModelTO setVisualLayouts(List<VisualLayoutTO> visualLayouts) {
   ...
   */
  public static PlantModelTO fromXml(Reader reader)
      throws IOException {
