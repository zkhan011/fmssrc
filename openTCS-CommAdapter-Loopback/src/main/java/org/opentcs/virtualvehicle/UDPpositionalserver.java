...
import static org.opentcs.virtualvehicle.AITVTCPCommunication.getCurrentVehicleAdapterForPositionUDP;

/**
 *
 * @author zisha
 */
public class UDPpositionalserver extends Thread {
    ...
    public UDPpositionalserver() throws SocketException {
    ...
    public void run() {
        ...
        while (running) {
           ...
           // getting adapter for the received vehicle data fro string
            myvehicleadapter = (AGVCommAdapter) getAGVCommAdapterName(vehiclename);
